...
<template>
    ...
    <div v-if="plane" class="background__plane" />
		<div class="background__clouds background__clouds_1"/>
		<div class="background__clouds background__clouds_2"/>
		<div class="background__clouds background__clouds_3"/>
	</div>
</template>
